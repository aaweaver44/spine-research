...
figure;
crank_matrix = crank_nicholson_spherical_Claude(r_start, r_end, t_start, t_end, ...
                                          Nr, Nt, D, IC, BC_R, k);

% Forward Euler (explicit, spherical)
figure;
forward_matrix = forward_difference_spherical_Claude(r_start, r_end, t_start, t_end, ...
                                               Nr, Nt, D, IC, BC_R, k);
